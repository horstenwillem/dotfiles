...
# This symlinks all the dotfiles (and .vscode/) to ~/
...
mv -f ~/.vscode ~/dotfiles_old/
ln -s $HOME/dotfiles/vscode ~/.vscode
echo "done"
...
ln -s "$DOTFILES_DIR/vscode/settings.json" "$vscode_dir"
ln -s "$DOTFILES_DIR/vscode/keybindings.json" "$vscode_dir"
ln -s "$DOTFILES_DIR/vscode/snippets" "$vscode_dir"
